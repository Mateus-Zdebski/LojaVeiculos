...
<div class="collapse navbar-collapse" id="navegacao">
    ...
    <div id="destaquesGerall">
        ...
        ?>
            ...
            <div class="destaq1">
                ...
                <div id="editExcbtnAdm">
                    <button id="btnalterar" onclick="location.href='/MotorCode/php2/EditarVeiculos.php?id=<?php echo $linha['id_veiculos']; ?>'"><b>Editar</b></button>
                    <button id="btnalterar" onclick="excluirVeiculo(<?php echo $linha['id_veiculos']; ?>)"><b>Excluir</b>
                    </button>
                </div>
            </div>
    ...
    <script>
        function excluirVeiculo(id) {
                     $confirmar =  window.confirm("Você tem certeza de que deseja excluir isso?");
                     if ($confirmar) {
            window.location.href = 'php2/ExcluVeiculos.php?id_veiculos=' + id;
