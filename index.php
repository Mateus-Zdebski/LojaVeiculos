...
<head>
    ...
    <style>
   .show-animate #titHist {
            animation: texto-flutuando 0.7s linear;
        }
        .show-animate #txtHist {
            animation: texto-flutuandoum 1s linear;
        }
        .show-animate #imagemm {
            animation: texto-flutuandodois 1s linear;
        }

        .show-animateee #txtDestaques {
            animation: texto-flutuando1 0.9s linear;
        }
        .show-animateee .destaqIndividual {
            animation: texto-flutuando2 0.7s linear;
        }

        @keyframes texto-flutuando {
            0% {
  ...
  <source src="Imagens/lv_0_20231204212553.mp4" type="video/mp4">
    ...
    <div id="geraldestques">
        ...
        <div id="destaquesGerall">
            ...
            ?>
                <a style="text-decoration: none" class="destaqIndividual" href="/MotorCode/compra.php?id=<?php echo $linha['id_veiculos']; ?>">
                    ...
                    <div class="divDescricao">
                        ...
                        <div id="divTxtDescri">
                            ...
                            <p class="espCar1">
                                <?php echo $kmrodado ?>Km
                            </p>
                            <p class="espCar1">
                                <?php echo $tipocombustivel ?>
                            </p>
                            <p class="categoriaOcul" style="visibility: hidden;">
                                <?php echo $categoria ?>
                            </p>
                        </div>
                        <h4 class="h4Estpreco1">R$
                            <?php echo $preco ?>
                        </h4>
                    </div>
    ...
    <div class="divBtEstoq">
        <a style="text-decoration: none" href="estoque.php">
    ...
    <div id="divHist">
        <div id="osdoisjuntoHist">
            ...
            <div id="txtHist">
                <p style="color: white; font-family: 'league-spartan-master', sans-serif ;" id="ptxtHist"><b>
    ...
    <script>
        ...
        let anima = document.querySelector('#divHist');

        window.addEventListener('scroll', () => {
            let top = window.scrollY;
            let offset = anima.offsetTop - window.innerHeight;
            let height = anima.offsetHeight;

            if (top >= offset && top < offset + height) {
                anima.classList.add('show-animate');
            } else {
                anima.classList.remove('show-animate');
            }
        });

        let anima1 = document.querySelector('#geraldestques');

        window.addEventListener('scroll', () => {
            let top1 = window.scrollY;
            let offset1 = anima1.offsetTop - window.innerHeight;
            let height1 = anima1.offsetHeight;

            if (top1 >= offset1 && top1 < offset1 + height1) {
                anima1.classList.add('show-animateee');
            } else {
                anima1.classList.remove('show-animateee');
            }
        });
    </script>
